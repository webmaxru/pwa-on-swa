...
function About() {
  ...
  return (
    <main>
      <h1>This is a PWA on SWA starter created for #30DaysOfSWA project</h1>
      ...
      <p>
        ...
        <a href="https://github.com/webmaxru/pwa-on-swa/issues/">
          the project GitHub repo
        </a>
        .
      </p>
      <h2>Service links for Azure Static Web Apps demo</h2>
      <p>
        <a href="https://github.com/webmaxru/pwa-on-swa/">
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            <a href="https://github.com/webmaxru/pwa-on-swa/blob/main/src/staticwebapp.config.json">
              sample
            </a>
            ) in the app route
          </p>
